...
https://www.youtube.com/watch?time_continue=855&v=cFnUDdi6DeE&feature=emb_logo
 * 
 * </pre>
 *
 */
public class NumberOfIslands {
	 ...
	 * 
	 * Or, Given one coordinate (i,j) of an island, obliterates the island from the
	 * given grid, so that it is not counted again.
	 * 
	...
	private void dfs(int i, int j) {
		...
		// Check all adjacent sites and turn them to '0' to indicate they are visited
		dfs(i + 1, j);
		dfs(i - 1, j);
		dfs(i, j + 1);
		dfs(i, j - 1);
	...
	public static void main(String[] args) {
		...
		System.out.println("Number of islands = " + islandCounter.numIslands(grid));
	}
}
